...
(function(e) {
    if ("function" == typeof bootstrap) bootstrap("react", e);
        ...
        if (!ses.ok()) return;
        ses.makeReact = e
    } else "undefined" != typeof window ? window.React = e() : global.React = e()
})(function() {
    ...
    return (function(e, t, n) {
            ...
            (function() {
                ...
                function mixSpecIntoComponent(Constructor, spec) {
                    ...
                    for (var name in spec) {
                        ...
                        if (specPolicy != null) {
                            invariant(!property || !property.__reactAutoBind,
        ...
        33: [function(require, module, exports) {
            (function() {
                ...
                var MOVE_NODE_AT_ORIG_INDEX = keyOf({
                    moveFrom: null
                });
                var INSERT_MARKUP = keyOf({
                    insertMarkup: null
                });
                var REMOVE_AT = keyOf({
                    removeAt: null
        ...
        45: [function(require, module, exports) {
            ...
            if (true) {
                ERRORS = {
                    MERGE_ARRAY_FAIL: 'Unsupported type passed to a merge function. You may have passed a ' +
                        'structure that contains an array and the merge function does not know ' +
                        'how to merge arrays. ',

                    MERGE_CORE_FAILURE: 'Critical assumptions about the merge functions have been violated. ' +
                        'This is the fault of the merge functions themselves, not necessarily ' +
                        'the callers.',

                    MERGE_TYPE_USAGE_FAILURE: 'Calling merge function with invalid types. You may call merge ' +
                    ...
                    MERGE_DEEP_MAX_LEVELS: 'Maximum deep merge depth exceeded. You may attempting to merge ' +
                        'circular structures in an unsupported way.',
                    MERGE_DEEP_NO_ARR_STRATEGY: 'You must provide an array strategy to deep merge functions to ' +
            ...
            var mergeHelpers = {
                ...
                checkMergeArrayArgs: function(one, two) {
                    throwIf(!Array.isArray(one) || !Array.isArray(two),
        ...
        55: [function(require, module, exports) {
            ...
            function forEachEventDispatch(abstractEvent, cb) {
                ...
                if (Array.isArray(dispatchListeners)) {
                    var i;
                    for (
                        i = 0; i < dispatchListeners.length && !abstractEvent.isPropagationStopped; i++) {
