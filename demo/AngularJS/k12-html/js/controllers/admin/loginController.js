angular.module("admin").controller('LoginController', ['$state', '$cookies', '$timeout', 'loginService','managerService','recordCookies', LoginController]);

function LoginController($state, $cookies, $timeout, loginService, managerService, recordCookies) {
    var vm = this;
