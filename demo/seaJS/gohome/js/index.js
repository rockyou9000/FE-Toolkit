...
//ping
	/*
        ...
        function playbksound() {
            ...
            sound_div.style.cssText = "position:fixed;left:10px;top:20px;z-index:50000;visibility:visible;";
            sound_div.onclick = switchsound;
            if (document.body.offsetWidth > 400) {
                bg_htm = "<img id='sound_image' src='img/music_note_big.png' width='30px'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:25px;top:-85px'></div>";
            }
            else {
                bg_htm = "<img id='sound_image' width='30px' src='img/music_note_big.png'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:25px;top:-85px'></div>";
            }
            txt_htm = "<div id='music_txt' style='color:white;position:absolute;left:35px;top:8px;width:60px'></div>"
